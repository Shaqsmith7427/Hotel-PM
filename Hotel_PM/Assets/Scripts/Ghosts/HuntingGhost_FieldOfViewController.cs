...
public class HuntingGhost_FieldOfViewController : MonoBehaviour
{
    #region Variables
    ...
    [SerializeField] private HuntingGhost_WanderController navMeshAgentWanderController;
    #endregion
    ...
    public void FindVisibleTargets()
    {
        ...
        for (int i = 0; i < targetsInViewRadius.Length; i++)
        {
            ...
            if (Vector3.Angle(transform.forward, directionToTarget) < viewAngle / 2)
            {
                ...
                if (!Physics.Raycast(transform.position, directionToTarget, distanceToTarget, obstacleMask) || Physics.Raycast(transform.position, directionToTarget, distanceToTarget, obstacleMask))
                {
            ...
            else
            {
                ...
                GetComponent<HuntingGhost_WanderController>().enabled = true;
            }
        }
